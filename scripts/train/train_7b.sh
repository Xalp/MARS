...
AR_OUTPUT="${BASE_DIR}/models/Qwen2.5-7B-Instruct/ar_sft"
MARS_OUTPUT="${BASE_DIR}/models/Qwen2.5-7B-Instruct/mars_blk${BLOCK_SIZE}"
RESULTS_DIR="${BASE_DIR}/results/qwen2.5_7b"
