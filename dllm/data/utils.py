...
def load_sft_dataset(
    ...
    try:
        ...
        load_dataset_alpaca = None
    try:
        from dllm.data.opc import load_dataset_opc_sft
    except ImportError:
        load_dataset_opc_sft = None
    ...
    for raw in specs:
        ...
        elif dataset_name_or_path.endswith(".jsonl") or "verified-math" in dataset_name_or_path:
             from dllm.data.verified_math import load_dataset_verified_math  # noqa: optional
             ds = load_dataset_verified_math(dataset_name_or_path)
        else:
            ds = load_dataset(dataset_name_or_path)
...
def load_pt_dataset(
    ...
    """
    from dllm.data.opc import load_dataset_opc_annealing  # noqa: optional
