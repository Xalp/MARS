...
class A2DQwen3InstructConfig(transformers.Qwen3Config):
    model_type = "a2d-qwen3-it"

class A2DQwen3InstructModel(transformers.Qwen3Model):
    def forward(
        self,
...
class A2DQwen3InstructLMHeadModel(transformers.Qwen3ForCausalLM):
    config: A2DQwen3InstructConfig

    def __init__(self, config):
        transformers.Qwen3PreTrainedModel.__init__(self, config)
        self.model = A2DQwen3InstructModel(config)
...
transformers.AutoConfig.register("a2d-qwen3-it", A2DQwen3InstructConfig)
transformers.AutoModel.register(A2DQwen3InstructConfig, A2DQwen3InstructLMHeadModel)
transformers.AutoModelForMaskedLM.register(A2DQwen3InstructConfig, A2DQwen3InstructLMHeadModel)
